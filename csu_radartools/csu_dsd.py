...
from csu_radartools.csu_blended_rain import _check_for_array
...
def d0_low_zdr(zdr, a=0.0203, b=-0.1488, c=0.2209, d=0.5571, e=0.801):
    return power_law(zdr, a, 4) + power_law(zdr, b, 3) + power_law(zdr, c, 2) +\
           power_law(zdr, d) + e
...
def calc_mu_sband_method1(d0, zeta, beta, a1=203.0, a2=1.89, b1=2.23, b2=0.0388,
