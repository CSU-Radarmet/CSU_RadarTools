...
#Step 2 is to run the warm layer HID. using csu_fhc_winter and warm == True
    ...
    scores_warm = csu_fhc_winter(dz=dz, zdr=zdr, rho=None, kdp=kdp, use_temp=True,T=T, band='C',warm = True,
                        verbose=True,fdir='/Users/bdolan/scratch/WINTER_HCA/winter-hid/beta_function_parameters/')
    ...
    scores_cold = csu_fhc_winter(dz=dz, zdr=zdr, rho=None, kdp=kdp, use_temp=True,T=T, band='C',warm = False,
                                verbose=True,fdir='/Users/bdolan/scratch/WINTER_HCA/winter-hid/beta_function_parameters/')
